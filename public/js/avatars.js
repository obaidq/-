...
const AvatarSystem = {
  ...
  GAME_AVATAR_CONFIG: {
    ...
    tshirtwars: {
      label: 'حرب التيشيرتات',
      dicebearStyle: 'fun-emoji',        // Colorful graffiti blobs
      cssClass: 'game-avatar--tshirtwars',
      svgFilter: 'none',
    ...
    inventions: {
      ...
      dicebearStyle: 'bottts',           // Steampunk robot gears
      cssClass: 'game-avatar--inventions',
      svgFilter: 'none',
      bgGradient: 'linear-gradient(135deg, #FFF8E7 0%, #F5E6C8 100%)',
      animation: 'avatar-gear',
      borderStyle: '3px solid rgba(205,127,50,0.5)',
      glowColor: 'rgba(205,127,50,0.4)'
    },
    wouldyourather: {
      label: 'شو تختار؟',
      dicebearStyle: 'thumbs',           // Split decision thumbs
      cssClass: 'game-avatar--wouldyourather',
      svgFilter: 'none',
      bgGradient: 'linear-gradient(135deg, #0A0E2A 0%, #141852 100%)',
      animation: 'avatar-split',
      borderStyle: '3px solid rgba(0,176,255,0.5)',
      glowColor: 'rgba(0,176,255,0.4)'
    },
    whosaidit: {
      label: 'مين قال؟',
      dicebearStyle: 'adventurer',       // Mystery detective characters
      cssClass: 'game-avatar--whosaidit',
      svgFilter: 'none',
      bgGradient: 'linear-gradient(135deg, #1A1A3E 0%, #2D2D5E 100%)',
      animation: 'avatar-ink',
      borderStyle: '3px solid rgba(156,39,176,0.5)',
      glowColor: 'rgba(156,39,176,0.4)'
    },
    speedround: {
      label: 'الجولة السريعة',
      dicebearStyle: 'pixel-art',        // Fast retro pixel racers
      cssClass: 'game-avatar--speedround',
      svgFilter: 'none',
    ...
    splittheroom: {
      label: 'اقسم الغرفة',
      dicebearStyle: 'shapes',           // Abstract split shapes
      cssClass: 'game-avatar--splittheroom',
      svgFilter: 'none',
      bgGradient: 'linear-gradient(135deg, #1B0A2E 0%, #4A0E78 100%)',
      animation: 'avatar-rift',
    ...
    debateme: {
      label: 'ناظرني',
      dicebearStyle: 'notionists',       // Formal courtroom faces
      cssClass: 'game-avatar--debateme',
      svgFilter: 'none',
